  ...
  const toggleUserStatus = async (userId: string, currentStatus: boolean) => {
    try {
      ...
      if (data.success) {
        ...
        toast.success(data.message || 'Cập nhật trạng thái người dùng thành công');
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Quản lý tài khoản và quyền truy cập của người dùng</p>
        </div>
